...
// $qry1=mysqli_query($con,"create procedure upfac(out ans VARCHAR(800)) UPDATE teacher SET ans='$ans',pic='$pic' WHERE ques='$key' ");
// mysqli_query($con,$qry1);

if($mode=="insert")
{

$sql="INSERT INTO teacher VALUES('$key','$ans','$pic','$picaddd')";
...
if($mode=="delete")
{
	$qry="DELETE FROM teacher WHERE ques='$key' ";
...
if($mode=="update")
{
$sql="UPDATE teacher SET ans='$ans',pic='$pic',picad='$picaddd' WHERE ques='$key'";
$check=mysqli_query($con,$sql);
if($check)
{
		echo "<script>";
