  ...
  $('#kont .text textarea').keypress(function(e){
      if(e.which == 13 && !e.shiftKey){
          ...
          if(sample.search("timetable")>=0)
            ...
            var keyword="events";
          else if(sample.search("holidays")>=0)
            var keyword="holidays";
            ...
            var keyword="hello";
          else if(sample.search("meeting")>=0)
            var keyword="meeting";
          else{
             $('#kont #backgroundofkont #messages').append('<li class="b">'+$('#kont .text textarea').val()+'</li>');
            $("#kont #backgroundofkont").animate({ scrollTop: 10000 }, "slow");
    ...
    $("#kont #backgroundofkont").animate({ scrollTop: 10000 }, "slow");
          ...
          $('#kont #backgroundofkont #messages').append('<li class="a" >'+'<a  href="'+data['picad']+'" alt="Image description" target="_blank"'+ data['picad']+'"><img  src=" ' + data['picad'] + '" style="width:500px;height:200px;" /></a>'+'</li>');
    }$("#kont #backgroundofkont").animate({ scrollTop: 10000 }, "slow");  
         }
     }
});
